  ...
  <div class="w-full overflow-hidden bg-white mx-1 my-2 rounded border">
    ...
    <div class="w-full flex flex-col lg:flex-row justify-start">
      <ul class="w-full lg:w-1/3 tracking-wider text-sm text-gray-600 flex flex-col items-center justify-start p-4 border-t">
        <li class="w-full py-1">Title: <span class="text-gray-700">{{ file.name }}</span></li>
        <li class="w-full py-1">Type: <span class="text-gray-700">{{ file.mime_type }}</span></li>
        <li class="w-full py-1">Size: <span class="text-gray-700">{{ file.size }} KB</span></li>
        <li class="w-full py-1">Public URL: <a class="hover:underline text-blue-500" :href="file.public_url" target="_blank">Click Here</a></li>
        <li class="w-full py-1">Created At: <span class="text-gray-700">{{ file.created_at }}</span></li>
      </ul>
